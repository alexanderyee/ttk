...
enum EnemyClass {COMMON_WORD, AGILE_WORD, TANK_WORD, AGILE_PHRASE, COMMON_PHRASE,
				TANK_PHRASE, LEFT_HAND_BOSS, NULL = -1}
...
const TANK_PHRASE_STATS := preload("res://resources/enemies/tank_phrase_enemy.tres")
const LEFT_HAND_BOSS_STATS := preload("res://resources/enemies/left_hand_boss_enemy.tres")
...
var class_to_stats_dict := {
	...
	EnemyClass.TANK_PHRASE: TANK_PHRASE_STATS,
	EnemyClass.LEFT_HAND_BOSS: LEFT_HAND_BOSS_STATS,
